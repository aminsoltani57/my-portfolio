  ...
  return (
    <>
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-kaushan">
        <span className="text-green ">Amin</span> Soltani
      </h3>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-green md:w-full ">
        <a href="https://wa.me/989172266469">
          <AiOutlineWhatsApp className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://www.linkedin.com/in/amin-soltani-677353124" >
          <AiFillLinkedin className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://github.com/aminsoltani57">
      ...
      >
        ...
        <p className="mx-2 mb-1"> aminsoltani57@gmail.com </p>
        <p className="mx-2 mb-1"> +989172266469 </p>
      </div>
      ...
      <button
        ...
        onClick={() => window.open("mailto:aminsoltani57@gmail.com")}
      >
        Email me
      </button>
      <button
